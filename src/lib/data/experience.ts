...
export const experiences: Experience[] = [
    {
        id: "researcher",
        title: "Researcher",
        description: "Researcher for two years, contributed to 10 papers, developed Federated Learning frameworks, designed experimental environments, and mentored bachelor's students final project.",
        date: "2023-09",
        endDate: "2025-08",
